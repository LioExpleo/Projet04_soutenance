...
class ClassVueMenu():
    def Action_menu(self):
        ...
        from Controleur.Ctrl_Tournoi import lect_tournois, sup_tournois, \
            ...
            lecture_match_tournoi, lecture_round_tournoi, \
            lecture_joueur_tournoi, lecturetournoi
        ...
        while (True):
            ...
            if (menu_niv_0 == "J" and
                    menu_niv_1 == "w" and saisie_clavier == "w"):
                creat_new_joueurs()

            if (menu_niv_0 == "J" and
                    menu_niv_1 == "r" and saisie_clavier == "r"):
                lect_joueurs()

            if (menu_niv_0 == "J" and
                    menu_niv_1 == "sup" and menu_niv_2 != ""):
            ...
            if (menu_niv_0 == "T" and
                    menu_niv_1 == "c" and saisie_clavier == "c"):
                charge_joueurs_tournoi()

            if (menu_niv_0 == "R" and
                    menu_niv_1 == "+" and saisie_clavier == "+"):
            ...
            if (clavier != "") and (clavier != "E"):
                ...
                if (clavier == "J"):
                    ...
                    print("Vous avez entré " + clavier +
                          " pour JOUEURS: r pour lecture, "
                          "w pour création de joueurs, "
                          "c pour charger dans un tournoi, "
                ...
                if (menu_niv0 == "R" and clavier == "+"):
                    ...
                    print(" Création d'un nouveau round :" +
                          clavier + " Sélectionner le tournoi où "
                                    "les 8 joueurs ont été saisis")
                ...
                if (clavier == "M"):
                    ...
                    print(" Vous avez entré :" +
                          clavier + " MATCH : r pour lecture, "
                                    "w pour écriture; si écriture, "
                                    "le round précédant se termine et "
                                    "la saisie des scores est à "
                                    "faire par paire")
                ...
                if (clavier == "JCN"):
                    menu_niv0 = clavier
                    print(" Vous avez entré :" +
                          clavier + " REQUETE AFFICHAGE DE TOUS LES ACTEURS "
                                    "PAR ORDRE ALPHABETIQUE")

                if (clavier == "JCC"):
                    menu_niv0 = clavier
                    print(" Vous avez entré :" + clavier +
                          " REQUETE  AFFICHAGE DE TOUS LES ACTEURS PAR ORDRE "
                          "DE CLASSEMENT")
                ...
                if (clavier == "TJ"):
                    menu_niv0 = clavier
                    print(" Vous avez entré :" + clavier +
                          " REQUETE AFFICHAGE DE TOUS LES JOUEURS D'UN TOURNOI"
                          " - ENTREZ L'ID DU TOURNOI")

                if (clavier == "TR"):
                    menu_niv0 = clavier
                    print(" Vous avez entré :" + clavier +
                          " REQUETE FFICHAGE DE TOUS LES ROUNDS D'UN TOURNOI")

                if (clavier == "TM"):
                    menu_niv0 = clavier
                    print(" Vous avez entré :" + clavier +
                          " REQUETE AFFICHAGE DE TOUS LES MATCHS D'UN TOURNOI")

                if (clavier == "TT"):
                    menu_niv0 = clavier
                    print(" Vous avez entré :" + clavier +
                          " REQUETE AFFICHAGE DE LA LISTE DES TOURNOIS")
